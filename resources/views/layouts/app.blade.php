...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title> E.N.O.S. v1.0  &lAarr;HR&copy;</title>
        ...
        <div class="menu-login">
              ...
              <ul class="">
                ...
                @else
                    ...
                    <a class="navbar-brand" href="/">ENOS</a>
                    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
                      <span class="navbar-toggler-icon"></span>
                    </button>
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                      <div class="navbar-nav">
                        <a class="nav-item nav-link " style="color:#fff;"  href="../alunos">Alunos </a>
                        <a class="nav-item nav-link"  style="color:#fff;" href="../professores">Professores</a>
                        <a class="nav-item nav-link"  style="color:#fff;" href="../cursos">Cursos</a>
                        <a class="nav-item nav-link " style="color:#fff;"  href="../disciplinas">Disciplinas</a>
                        <a class="nav-item nav-link " style="color:#fff;"  href="../notas">Notas</a>
                      </div>
                    </div>
